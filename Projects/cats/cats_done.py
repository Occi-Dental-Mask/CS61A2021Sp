...
def accuracy(typed, reference):
    ...
    total_r = len(reference_words)
    if total_t == 0 and total_r != 0 or total_t != 0 and total_r == 0:
        return 0.0
    ...
    for i in range(total_t):
        ...
        if typed_words[i] == reference_words[i]:
            correct_num += 1
    #if isinstance(correct_num/total_t*100,int):
    return correct_num/total_t*100
    #else:
        #return round(round(correct_num/total_t,4)*100,2)
    # END PROBLEM 3
