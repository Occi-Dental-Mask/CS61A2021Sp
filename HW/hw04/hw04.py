...
def replace_thor_at_leaf(t, thors_replacement):
    ...
    if label(t) == 'thor' and is_leaf(t):
        ...
        after_branch = [replace_thor_at_leaf(b,thors_replacement) for b in branches(t)]
        return tree(label(t),after_branch)
...
def replace(t):
    if is_leaf(t):
        ...
        new_branches = [replace(b) for b in branches(t)]
        print(new_branches)
